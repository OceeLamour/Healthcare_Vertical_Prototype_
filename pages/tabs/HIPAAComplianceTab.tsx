...
export default function HIPAAComplianceTab() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-primary">HIPAA Compliance</h1>
      <p className="text-secondary mb-6">Manage HIPAA compliance settings, PII redaction, and audit trails.</p>
