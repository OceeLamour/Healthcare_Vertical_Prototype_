...
export default function PatientIntakeTab() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-primary">Patient Intake</h1>
      <p className="text-secondary mb-6">Build secure forms for patient information.</p>
            ...
            <div key={field.key} className="border-t border-gray-200 pt-4 first:border-t-0 first:pt-0">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-secondary">Field Label</label>
                  <input
                    type="text"
                    value={field.label}
                    onChange={(e) => {
                ...
                <div className="flex items-center space-x-4">
                  <div>
                    <label className="block text-sm font-medium text-secondary text-center">Required?</label>
                    <select
                  ...
                  <div>
                    <label className="block text-sm font-medium text-secondary text-center">PHI?</label>
                    <select
